...
| Card | Shows |
|------|-------|
| **Credits Balance** | Available credits for the active team |
| **Credits Used** | Total credits consumed by the active team |
| **Team Plan** | The active team's plan (Free, Pro, or Max) |

Credit data is fetched via `api.credits.getTeamCredits`.
