...
const useResizeObserver = (
  ...
  useEffect(() => {
    ...
    // dependencies passed as variable by design — this hook abstracts useEffect
...
const useAnimationLoop = (
  ...
  useEffect(() => {
    ...
    // trackRef is a stable ref — not needed as a dependency
    // eslint-disable-next-line react-hooks/exhaustive-deps
  ...
  ({
    ...
    const renderLogoItem = useCallback(
      (item: LogoItem, key: React.Key) => {
        ...
        const inner = (item as LogoNodeItem | LogoImageItem).href ? (
          <a
            className={cx(
            ...
            href={(item as LogoNodeItem | LogoImageItem).href}
